...
public enum CloudErrorCode implements BaseErrorCode {
    ...
    CLOUD_PROVIDER_NOT_FOUND(HttpStatus.NOT_FOUND, 4008, "클라우드 프로바이더를 찾을 수 없습니다."),
    CLOUD_RESOURCE_NOT_FOUND(HttpStatus.NOT_FOUND, 4009, "클라우드 리소스를 찾을 수 없습니다."),
    CLOUD_REGION_NOT_FOUND(HttpStatus.NOT_FOUND, 4010, "클라우드 리전을 찾을 수 없습니다."),
    CLOUD_SERVICE_NOT_FOUND(HttpStatus.NOT_FOUND, 4011, "클라우드 서비스를 찾을 수 없습니다."),
